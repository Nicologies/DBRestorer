...
public class SqlServerUtil : SqlServerUtilBase
{
    public static readonly string FinishedRestore = "Finished Restoring.";
    private readonly SqlServerInstanceNames _instancesProvider = new();
    private readonly SqlServerDatabases _databasesProvider = new();
    ...
    public override async Task Restore(DbRestoreOptions opt, IProgressBarProvider progressBarProvider,
